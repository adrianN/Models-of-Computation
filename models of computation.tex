...
\input{./lectures/twentytwo}
\input{./lectures/twentythree}
\input{./lectures/twentyfour}
\input{./lectures/twentyfive}
\input{./lectures/twentysix}
\input{./lectures/twentyseven}
\end{document}
